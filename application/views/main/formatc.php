            ...
            <div class="row">
                <div class="input-group col-6">
                    <div class="input-group-prepend">
                        <button class="btn btn-primary" type="button" onclick="$('#jumlahatc').val(parseFloat($('#jumlahatc').val())-1).trigger('change')"><i class="fas fa-minus"></i></button>
                    </div>
                    <input type="number" class="form-control text-center" id="jumlahatc" name="jumlah" value="1" max="<?=$totalstok?>" required />
                    <div class="input-group-append">
                        <button class="btn btn-primary" type="button" onclick="$('#jumlahatc').val(parseFloat($('#jumlahatc').val())+1).trigger('change')"><i class="fas fa-plus"></i></button>
                    </div>
                </div>
                <div class="col-6 text-primary" <?php if($set->tampil_stok == 0){ echo "style='display:none'"; } ?>>
    ...
    $(function(){
        ...
        $("#varian").change(function(){
            ...
            <?php }else{ ?>
				...
				$("#jumlahatc").attr("max",$(this).find(":selected").data('stok'));
