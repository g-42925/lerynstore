...
<script type="text/javascript">
	$(function(){
		$("#form").on("submit",function(e){
			...
			$.post("<?php echo site_url("home/signin/pwreset"); ?>",datar,function(msg){
				var data = eval('('+msg+')');
				...
				if(data.success == true){
					...
					swal.fire("Berhasil!","Berhasil mengirimkan password baru, silahkan cek inbox email Anda.","success").then((value) =>{
						window.location.href = "<?php echo site_url("home/signin"); ?>";
					});
				}else{
					swal.fire("Gagal!","Alamat email tidak ditemukan, pastikan alamat email sudah benar.","error");
				}
			});
		});
	});
