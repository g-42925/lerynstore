...
<script type="text/javascript">
	...
	function loadRiwayat(){
		...
		$.post("<?=site_url($this->func->admurl()."/manage/laporanppob?load=hal")?>",{"status":$("#status").val(),"tglmulai":$("#tglmulai").val(),"tglselesai":$("#tglselesai").val(),[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval("("+msg+")");
