	...
	<div class="row">
		<div class="col-md-6 m-b-20">
			...
			<div class="form-group">
				...
				<textarea name="jamkerja" class="form-control" rows="4"><?=$set->jamkerja?></textarea>
			</div>
			<div class="form-group">
		...
		<div class="col-md-6 m-b-20">
			<div class="logoset">
				<div class="logo">
					...
					<img id="logo" src="<?=base_url("assets/images/".$set->logo)?>" />
			...
			<div class="logoset">
				<div class="favicon">
					...
					<img id="favicon" src="<?=base_url("assets/images/".$set->favicon)?>" />
...
<script type="text/javascript">
	$(function(){
		...
		$("#faviconUpload").change(function(){
			...
			$.ajax( {
                url        : '<?php echo site_url($this->func->admurl()."/api/uploadLogo/2"); ?>',
                type       : 'POST',
                contentType: false,
                cache      : false,
                processData: false,
                ...
                success    : function ( data )
                {
					...
					if(res.success == true){
						$("#favicon").attr("src","<?=base_url('assets/images/')?>"+res.filename);
					}
                }
            } );
		});
		...
		$("#logoUpload").change(function(){
			...
			formData.append($("#names").val(),$("#tokens").val());
			$.ajax( {
                url        : '<?php echo site_url($this->func->admurl()."/api/uploadLogo/1"); ?>',
                type       : 'POST',
                contentType: false,
                cache      : false,
                processData: false,
                ...
                success    : function ( data )
                {
					...
					updateToken(res.token);
					if(res.success == true){
						$("#logo").attr("src","<?=base_url('assets/images/')?>"+res.filename);
					}
                }
            } );
		});
