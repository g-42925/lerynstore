<?php
			...
			foreach($db->result() as $r){
				...
				$button = "
					<!--<a href='".site_url($this->func->admurl()."/orderform/index/".$r->id)."' title='copy' class='btn btn-warning btn-sm m-b-4'><i class='fas fa-list-alt'></i> Form Order</a>-->
					...
					<a href='".site_url($this->func->admurl().'/manage/produkform/?copy='.$r->id)."' title='copy' class='btn btn-success btn-sm m-b-4'><i class='fas fa-copy'></i> Duplicate</a>
					<a href='".site_url($this->func->admurl().'/manage/produkform/'.$r->id)."' title='edit' class='btn btn-primary btn-sm m-b-4'><i class='fas fa-pencil-alt'></i> Edit</a>
