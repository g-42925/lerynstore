<div class="table-responsive">
	<table class="table table-condensed table-hover">
		...
		<?php
			...
			$where = "status = 4 AND (orderid LIKE '%$cari%' OR usrid IN(".$in.") OR usrid_temp IN(".$int."))";
			$this->db->select("id");
			$this->db->where($where);
		...
		?>
			<tr>
				<td class="text-center"><i class="fas fa-times-circle text-danger"></i> &nbsp; <?=$this->admfunc->ubahTgl("d M Y H:i",$r->tgl).$cod;?></td>
				<td>
					<div class="m-b-6">
