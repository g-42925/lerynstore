...
<script type="text/javascript">
    $(function(){
        ...
        $("#simpanvarian").on("submit",function(e){
            ...
            setTimeout(function(){
                $.post("<?=site_url($this->func->admurl()."/api/varianadd")?>",datar,function(msg){
                    var data = eval("("+msg+")");
        ...
        $("#simpansubvarian").on("submit",function(e){
            ...
            setTimeout(function(){
                $.post("<?=site_url($this->func->admurl()."/api/subvarianadd")?>",datar,function(msg){
                    var data = eval("("+msg+")");
                    updateToken(data.token);
                    if(data.success == true){
                        loadVariasi();
    ...
    function simpanVariasi(){
        ...
        /*
        $.post("<?=site_url($this->func->admurl()."/api/variansave/".$id)?>",datar,function(msg){
            var data = eval("("+msg+")");
            updateToken(data.token);
            if(data.success == true){
        ...
        */
        $.ajax({
            type: "POST",
            url:  "<?=site_url($this->func->admurl()."/api/variansave/".$id)?>",
            data: datar,
            statusCode: {
    ...
    function hapusVarian(id){
        swal.fire({
            ...
            if(val.value){
                $.post("<?=site_url($this->func->admurl()."/api/varianhapus")?>",{"id":id,"produk":<?=$id?>,[$("#names").val()]:$("#tokens").val()},function(msg){
                    var data = eval("("+msg+")");
                    updateToken(data.token);
                    if(data.success == true){
                        loadVariasi();
    ...
    function hapusSubvarian(id){
        swal.fire({
            ...
            if(val.value){
                $.post("<?=site_url($this->func->admurl()."/api/subvarianhapus")?>",{"id":id,"produk":<?=$id?>,[$("#names").val()]:$("#tokens").val()},function(msg){
                    var data = eval("("+msg+")");
                    updateToken(data.token);
                    if(data.success == true){
                        loadVariasi();
