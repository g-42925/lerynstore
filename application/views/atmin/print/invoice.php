	...
	<div class="nota">
		...
		?>
			<div class="header row m-lr-0 m-t-10 m-b-40">
				<div class="col-6 logo"><img src="<?=base_url("assets/images/".$set->logo)?>" /></div>
						...
						foreach($db->result() as $r){
							...
							echo "
								<tr>
									...
									<td class=\"text-right\">Rp".$this->admfunc->formUang($r->diskon+$r->harga)."</td>
					...
					<div class="row">
						<div class="col-6">
							...
							<div class="p-t-20">
								...
								<b><?=$this->admfunc->getKurir($trx->kurir,"nama")." - ".$this->admfunc->getPaket($trx->paket,"nama")?></b>
							</div>
						</div>
						<div class="col-6">
