<h4 class="page-title">Statistik Pengunjung Website</h4>
...
<script type="text/javascript">
	...
	function loadRiwayat(){
		...
		$.post("<?=site_url($this->func->admurl()."/statistik/pengunjungload")?>",{"mulai":$("#tglmulai").val(),"selesai":$("#tglselesai").val(),[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval("("+msg+")");
