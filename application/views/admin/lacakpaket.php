        ...
        <div class="col-md-5 m-lr-auto m-b-30">
          ...
          <div class="section p-lr-24 p-tb-30">
            <div class="p-b-10 p-t-10">
              <p class="m-b-20">
                Kurir Pengiriman:
                <div class='badge badge-warning fs-18 m-b-6'><?php echo strtoupper(strtolower($this->func->getKurir($transaksi->kurir,"nama"))); ?></div>
                <div class='text-warning fs-16 font-bold'><?php echo strtoupper(strtolower($this->func->getPaket($transaksi->paket,"nama"))); ?></div>
              </p>
              <p class="m-b-10">
