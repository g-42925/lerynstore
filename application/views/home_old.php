	...
	?>
	<!-- PPOB -->
	<section class="banner p-t-45 p-b-40">
		<div class="container">
	...
	<section class="banner p-t-45 p-b-40 m-b-40">
		...
		<div class="t-center m-tb-20">
			<a href="<?=site_url("home/kategori")?>" class="btn btn-primary">Lihat Semua Kategori <i class="fas fa-chevron-circle-right"></i></a>
		</div>
	</section>
	...
	<section class="newproduct p-b-40">
		<div class="container">
			...
			<div class="section-title p-b-20 showsmall">
				<div class="row">
					<div class="col-8 font-bold text-primary fs-20">FLASHSALE</div>
		...
		<div class="t-center m-tb-20">
			<a href="<?=site_url("flashsale")?>" class="btn btn-primary">Lihat Semua Produk Flashsale <i class="fas fa-chevron-circle-right"></i></a>
		</div>
	</section>
	<?php } ?>
			...
			<div class="row">
				...
				?>
					<div class="col-md-4 iklans m-b-20">
						<a href="<?=$this->func->cleanURL($iklan->link)?>">
	...
	<section class="newproduct p-t-60 p-b-40">
		<div class="container">
			...
			<div class="section-title p-b-20 showsmall">
				<div class="row">
					<div class="col-8 font-bold text-primary fs-20">PRODUK PILIHAN</div>
					<div class="col-4 text-right">
						<button id="viewpilihangrid" style="display:none;" class="btn btn-default" type="button" onclick="$('#viewpilihanlist').show();$('#viewpilihan').toggleClass('produk-list');$(this).hide()"><i class="fas fa-border-all"></i> Grid</button>
						<button id="viewpilihanlist" class="btn btn-default" type="button" onclick="$('#viewpilihangrid').show();$('#viewpilihan').toggleClass('produk-list');$(this).hide()"><i class="fas fa-bars"></i> List</button>
					</div>
				</div>
			</div>

			<!-- Slide2 -->
			<div class="row display-flex produk-wrap" id="viewpilihan">
				<?php
					if(count($notin) > 0){
		...
		<div class="t-center m-t-20">
			<a href="<?=site_url("shop")?>" class="btn btn-primary">Lihat Semua Produk <i class="fas fa-chevron-circle-right"></i></a>
		</div>
	</section>
	...
	<section class="newproduct p-t-60 p-b-40">
		<div class="container">
			...
			<div class="section-title p-b-20 showsmall">
				<div class="row">
					<div class="col-8 font-bold text-primary fs-20">PRODUK DIGITAL</div>
					<div class="col-4 text-right">
						<button id="viewdigitalgrid" style="display:none;" class="btn btn-default" type="button" onclick="$('#viewdigitallist').show();$('#viewdigital').toggleClass('produk-list');$(this).hide()"><i class="fas fa-border-all"></i> Grid</button>
						<button id="viewdigitallist" class="btn btn-default" type="button" onclick="$('#viewdigitalgrid').show();$('#viewdigital').toggleClass('produk-list');$(this).hide()"><i class="fas fa-bars"></i> List</button>
					</div>
				</div>
			</div>

			<!-- Slide2 -->
			<div class="row display-flex produk-wrap" id="viewdigital">
				<?php
					foreach($db->result() as $r){
						$level = isset($_SESSION["lvl"]) ? $_SESSION["lvl"] : 0;
						if($level == 5){
	...
	<section class="testismoni p-t-45 p-b-40 m-b-40">
		<div class="container">
			...
			<?php
				foreach($db->result() as $r){
			?>
			<div class="brick" onclick="openGal('<?=base_url('cdn/brand/'.$r->icon)?>')">
	...
	<div class="modal popup-banner" data-backdrop="static" data-keyboard="false" id="popGaleri" tabindex="-1">
