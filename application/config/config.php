...
$config['csrf_token_name'] = 'by_masbil';
$config['csrf_cookie_name'] = 'jadiorder';
...
$config['csrf_exclude_uris'] = array(
    ...
    "f/[a-z]+",
    "assync/notifchat",
    "atmin/api/cekupdatenotif",
    "atmin/api/updateproduk",
    "atmin/api/tambahproduk",
    "atmin/api/varianhapus",
    "atmin/api/subvarianhapus",
    "atmin/api/uploadFotoProduk",
    "atmin/api/uploadFotoResult/[0-9]+",
    "atmin/editor/[a-z]+",
    "atmin/orderform/[a-z]+",
);
